    ...
    <div className="w-screen bg-[#f5f4f0] pb-10">
      <div className="w-[90%] lg:w-[75%] h-full mx-auto pt-5">
        <div className="flex justify-between items-center">
          ...
          <Link to={"/seeAll"} className="text-lg lg:text-xl text-orange-500 font-semibold cursor-pointer hover:underline transition-all duration-300">
            See All
          </Link>
        </div>
